...
def elp_evk4(root_folder, sample_num=1, vis = False):

    frame_folder = root_folder + f'/davis_frames_{1}'
    ...
    frame_folder = root_folder + '/davis_frames_1'
    ...
    for i, file in enumerate(selected_files):
        ...
        while t < end_time:
            ...
            if max(filter_laplacian_product) - min(filter_laplacian_product) > 5 and min(
                    filter_laplacian_product) < -2:  ## for 50fps
