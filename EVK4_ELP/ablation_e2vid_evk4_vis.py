...
def elp_real_evk4(root_folder,vis=False):
    frame_folder = root_folder + '/e2vid'
    ...
    jpg_files = glob.glob(os.path.join(frame_folder, 'good.png'))
...
# # 静止场景
# root_folder = r'F:\Event_camera\DVS_AF_est\dataset\rebuttal\EVK4\high\bright_motion'
